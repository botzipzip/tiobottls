	...
	nzwa.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				success: '✔️ Funcionou âœ”ï¸',
                                levelon: '✔️ *level ativado*',
				leveloff: ' ✔️  *level desativado*',
				levelnoton: '❌­ *level não ativado*',
				levelnol: '*SEU NIVEL É...* 0 °-°',
				error: {
					stick: '❌ERRO AO CONVERTER IMG EM STICKER❌',
					Iv: '❌LINK INVALIDO KCT❌'
				},
				only: {
					group: '[❕]Este comando só pode ser usado em grupos!',
					ownerG: '[❕]Este comando só pode ser usado pelo grupo proprietário!',
					ownerB: '[❕]Este comando só pode ser usado pelo bot do proprietário!',
					admin: '[❕]Este comando só pode ser usado por administradores de grupo!',
					Badmin: '[❕]Este comando só pode ser usado quando o bot é um administrador!',
                                        daftarB: `──「SEM REGISTRO」──\nMan c n ta registrado !\nSEGUINTE c tem q se registrar como esse exemplo ai... \n\nCommand : ${prefix}register nome|idade\nContoh : ${prefix}register TioBot|17`,
				}
			}
    			const apakah = ['Ya','Tidak']
        		const bisakah = ['Bisa','Tidak Bisa']
		        const kapankah = ['Hari Lagi','Minggu Lagi','Bulan Lagi','Tahun Lagi']
			const botNumber = tiobot.user.jid
